...
void CCheckBox::Draw(bool hover)
{
	...
	Render::Outline(a.x, a.y, 13, 13, Color(30, 30, 30, 255));
	Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(129, 129, 129, 180));
	if (hover)
	{
		if (Checked)
		{
	...
	else if (Checked)
	{
		...
		Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(177, 247, 27, 255));
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(20, 20, 20, 80));
	}
}
...
{
	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y, Color(60, 60, 60, 255), Render::Fonts::MenuBold, Text.c_str());
}
...
void CGroupBox::Draw(bool hover)
{
	...
	Render::Text(a.x + 15, a.y - (txtSize.bottom / 2), Color(60, 60, 60, 255), Render::Fonts::MenuBold, Text.c_str());
...
void CSlider::Draw(bool hover)
{
	...
	//Render::Clear(a.x, a.y + 2, Location, 10, Color(200, 0, 0, 255));
		...
		Render::Clear(a.x, a.y + 2, Location, 10, Color(177, 247, 27, 255));
	}
	Render::Clear(a.x, a.y + 2, Location, 10, Color(177, 247, 27, 255));
...
void CButton::Draw(bool hover)
{
	...
	Render::Text(TextX, TextY, Color(60, 60, 60, 255), Render::Fonts::MenuBold, Text.c_str());
}
